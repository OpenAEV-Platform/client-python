"""Tests for the contracts public surface exposed by xtm_oaev_sdk."""

import json

import pytest
import xtm_oaev_sdk as sdk
...
def _then_public_symbol_exists(symbol, name: str) -> None:
    assert symbol is not None, f"Expected xtm_oaev_sdk.{name} to exist on public surface"
...
def test_contract_public_surface_exposes_expected_symbols(symbol_name: str) -> None:
    """Verifies the xtm_oaev_sdk public surface exposes required contract symbols."""
