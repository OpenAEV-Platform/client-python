...
def test_create_mq_ssl_context_imports_ssl_cert_chain_from_sdk() -> None:
    """It imports ssl_cert_chain from xtm_oaev_sdk for create_mq_ssl_context."""
    source = _given_helpers_source()
