...
def test_daemon_protocol_import_from_public_surface() -> None:
    """AC-D01: DaemonProtocol is importable from xtm_oaev_sdk."""
...
def test_daemon_protocol_is_exported_in_module_all() -> None:
    """AC-D06: DaemonProtocol is in xtm_oaev_sdk.__all__."""
...
def test_importing_daemon_protocol_no_circular_imports() -> None:
    """AC-D18: from xtm_oaev_sdk import DaemonProtocol exits cleanly."""
    result = _when_running_python_import("from xtm_oaev_sdk import DaemonProtocol")
    _then_process_exit_code_is_zero(result)
