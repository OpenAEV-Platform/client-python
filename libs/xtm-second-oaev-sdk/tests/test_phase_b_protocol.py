...
def _given_base_client_class():
    from xtm_second_oaev_sdk import BaseClient
...
def test_base_client_import_from_public_surface() -> None:
    """AC-B01: BaseClient is importable from xtm_second_oaev_sdk."""
...
def test_base_client_is_exported_in_module_all() -> None:
    """AC-B08: BaseClient is exported via xtm_second_oaev_sdk.__all__."""
...
def test_importing_base_client_does_not_trigger_circular_imports() -> None:
    """BLIND-3: from xtm_second_oaev_sdk import BaseClient exits cleanly."""
    result = _when_running_python_import("from xtm_second_oaev_sdk import BaseClient")
